		...
		points?.forEach((point) => {
			...
			if (episode) {
				...
				if (assignment) {
					...
					assignmentGroup.points.push(point as unknown as Point);
				} else {
					group.otherPoints.push(point as unknown as Point);
				}
			} else {
				const generalGroup = acc['general'];
				if (generalGroup) {
					generalGroup.otherPoints.push(point as unknown as Point);
				}
			}
		});
...
export default SqlUserDetailPage;
