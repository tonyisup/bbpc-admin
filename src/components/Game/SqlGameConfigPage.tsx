...
import GamePointTypeModal from "./GamePointTypeModal";
import GamblingTypeModal from "./GamblingTypeModal";
import type { GamePointType, GameType, GamblingType } from "@prisma/client";

const SqlGameConfigPage: NextPage = () => {
...
export default SqlGameConfigPage;
