...
const MovieDetailPage: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
  ...
  return (
    <>
      <Head>
        <title>{`${movie.title} - Movie Details | BBPC Admin`}</title>
      </Head>
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <Card className="border-none shadow-xl bg-gradient-to-br from-card to-muted/30">
              <CardHeader>
                ...
                <CardDescription>Episodes where this movie was reviewed or assigned.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <Card className="border-none shadow-xl">
              <CardHeader>
                ...
                <CardDescription>All user reviews for this movie.</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
